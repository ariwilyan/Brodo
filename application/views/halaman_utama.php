...
<html>
    ...
    <body>
        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="assets/1.png" alt="" width="1100" height="500">
                  </div>
                  <div class="carousel-item">
                    <img src="assets/2.png" alt="" width="1100" height="500">
                  </div>
                  <div class="carousel-item">
                    <img src="assets/3.png" alt="" width="1100" height="500">
                  </div>
                  <div class="carousel-item">
                    <img src="assets/4.png" alt="" width="1100" height="500">
                  </div>
                  <div class="carousel-item">
                    <img src="assets/5.png" alt="" width="1100" height="500">
                  </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-4" style="margin: 20px 15px 20px 15px;margin-right: 15px;">
                <img src="assets/grid1.PNG" width="150%" height="55%">
            </div>
            <div class="col-sm-4" style="margin: 20px 15px 20px 15px; margin-left: 185px;">
                <img src="assets/grid2.PNG" width="150%" height="55%">
            </div>
        </div>
        <div class="row">
                <div class="col-sm-3" style="margin: 5px 55px 5px 5px;margin-left: 15px;">
                    <img src="assets/grid3.PNG" width="135%" height="35%">
                </div>
                <div class="col-sm-3" style="margin: 5px 5px 5px 5px;margin-left: 35px;">
                    <img src="assets/grid4.PNG" width="135%" height="35%">
                </div>
                <div class="col-sm-3" style="margin: 5px 5px 5px 5px; margin-left: 95px;">
                    <img src="assets/grid5.PNG" width="135%" height="35%">
                </div>
        </div> 
    </body>
    <div class="container-fluid" id="footer" style="background-color: whitesmoke;padding: 50px; margin-top: 10px; text-align:center;">
        <h3 class="text-bold text-center" style="font-size:14px;color: #003142;">Gak mau ketinggalan promo dari Brodo?</h3>
        <p class="text-center" style="font-size:13px;color: #003142;;">Berlangganan sekarang!</p>
        <div class="form-group mx-sm-3 sm-2">
            <input type="email" class="form-md-control" id="inputemail" placeholder="Masukkan e-mail Bro/Sis">
            <button type="button" class="btn btn-default btn-md" style="background-color:#003142; color:white;">Kirim</button>
        </div>
        
    </div>
    <div class="container-fluid">
        <div class="row" style="background: #003142;">
            <div class="col-md-2" style="padding-top:30px;">
                <img src="assets/brodocoklat.png" width="120" height="45">
            </div>
            <div class="col-md-2" style="color:white;padding-top:30px;">
                <p style="font-weight:bold; font-size:18px;">BRODO FOOTWEAR</p>
                <div class="row">
                        <div class="column" style="font-size:12px; padding-bottom: 15px;">
                            <p>Cara Pemesanan</p>
                            <p>Konfirmasi Pembayaran</p>
                            <p>Pengembalian dan Penukaran</p>
                            <p>Bantuan dan Saran</p>
                            <p>Hubungi Kami</p>
                            <p>Testimonial</p>
                        </div>
                </div>
            ...
            <div class="col-md-2" style="color:white;padding-top:30px;">
                    <p style="font-weight:bold; font-size:18px;">LEGAL</p>
                    <div class="row">
                            <div class="column" style="font-size:12px; padding-bottom: 15px;">
                    ...
                    <div class="row">
                            <div class="column" style="font-size:12px; padding-bottom: 15px;">
                                <p style="font-weight:bold; font-size:18px;">LAINNYA</p>
                                <p>Jurnal</p>
                                <p>Halaman Video</p>
                            </div>
                    </div>
            ...
            <div class="col-md-2" style="color:white;padding-top:30px;">
                    <p style="font-weight:bold; font-size:18px;">KONTAK BRODO</p>
                    <div class="row">
                            <div class="column" style="font-size:12px; padding-bottom: 15px;">
                                <p>Customer service kami dapat dihubungi 7 hari dalam seminggu, hari kerja antara pkl. 08.00 - 21.00 & akhir pekan pkl. 10.00 - 21.00.</p>
                                <p>Call Center :
                                    0811 854 5555
                                    0888 0808 5555</p>
            ...
            <div class="col-md-2" style="color:white;padding-top:30px;">
                <img src="assets/footer.png" width="250" height="150">
            </div>
        </div>
    </div>
</html>
